...
f = Product.create(
       name: "Dron",
       description: "Captura mejores imágenes con la ayuda de este aparato.",
       price: 7000,
       imagen:"https://images.unsplash.com/photo-1541504619657-2a60d7301207?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODR8fGNhbWVyYXxlbnwwfDJ8MHx8&auto=format&fit=crop&w=500&q=60"
)
